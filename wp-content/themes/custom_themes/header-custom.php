...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300,500&subset=latin,cyrillic' rel='stylesheet'
          type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400,700&subset=latin,cyrillic' rel='stylesheet'
          type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Ubuntu:400,500,700' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="<?php bloginfo("template_url"); ?>/fw/css/font-awesome.css">
...
$defaults = array(
    ...
    'menu' => 'main',
    'container' => 'nav',
    'container_class' => 'main_menu_mob mobile-only custom-template-menu',
    ...
    <header id="header">
        <div class="ss-container">
            <div class="custom-header__wrap">
                ...
                <a class="phone_button mobile-only" href="#"><i class="fa fa-phone"></i></a>
                <div class="ss-row">
                    <div class="col col-35 col-no-pad-right custom-header__logo__wrap">
                        <a class="custom-header__logo" href="<?php echo site_url(); ?>">
                            <img class='inner-page'
                                 src="<?php bloginfo("template_url"); ?>/img/images/descktop_logo.png"
                                 alt="">
                            <img class='home-page'
                                 src="<?php bloginfo("template_url"); ?>/img/images/descktop_logo_home.png"
                                 alt="">
                        </a>
                    </div>
                    <div class="col col-65 col-no-pad-left menu-wrap">
     <span class="call_us desktop-only">Позвоните нам:
         <a href="tel:+380 (44) 361-18-16">
             <i class="fa fa-phone"></i> (044) 361 1816
         </a>
